...
e2 = Event.create!(title: "Wall climb", user_id: d.id, searcher_id: q.id, interests: "wall climb", description: "Looking for someone to wall climb with this evening. I'm an interemediate climber.", location: "Triangle Rock Club", searcherinterested: a.id, posterinterested: b.id)
...
e3 = Event.create!(title: "Drink a beer", user_id: d.id, searcher_id: a.id, interests: "beer brewery tour", description: "Wanting to try a couple bars tonight", location: "Downtown Durham", searcherinterested: d.id, posterinterested: a.id )
...
e4 = Event.create!(title: "18 Holes", user_id: d.id, searcher_id: b.id, interests: "golf", description: "I shoot on average 90 to 100. I have an 8 o'clock tee time for course 1", location: "Pinehurst", searcherinterested: d.id, posterinterested: b.id )
...
e5 = Event.create!(title: "Bowling", user_id: q.id, searcher_id: a.id, interests: "bowling", description: "Looking to knock some pins over with another amateur", location: "AMC Bowling, Cary", searcherinterested: q.id, posterinterested: a.id )
...
e6 = Event.create!(title: "Durham Bull's Game", user_id: q.id, searcher_id: b.id, interests: "baseball relax", description: "I have an extra ticket and don't want to go alone", location: "Durham", searcherinterested: q.id, posterinterested: b.id)
...
e7 = Event.create!(title: "Pedicures", user_id: ak.id, searcher_id: a.id, interests: "manicure pedicure", description: "I have a reservation at the spa for two at 11 if anyone wants to join me", location: "The Umstead Hotel and Spa Cary", searcherinterested: a.id, posterinterested: a.id )
