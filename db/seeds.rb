...
e = Event.create!(title: "All I Need", user_id: d.id, searcher_id: q.id, interests: "coffee", description: "Her green plastic watering can For her fake Chinese rubber plant", location: "Cocoa Cinnamon", searcherinterested: true, posterinterested: true )
...
e2 = Event.create!(title: "The Struggle is Real", user_id: d.id, searcher_id: q.id, interests: "coffee", description: "In the fake plastic earth That she bought from a rubber man", location: "London", searcherinterested: true, posterinterested: true)
...
e3 = Event.create!(title: "Karma Police", user_id: d.id, searcher_id: a.id, interests: "roller skating", description: "In a town full of rubber plans To get rid of itself", location: "Skate Dates", searcherinterested: true, posterinterested: true )
...
e4 = Event.create!(title: "Fake Plastic Trees", user_id: d.id, searcher_id: b.id, interests: "cheese", description: "She lives with a broken man A cracked polystyrene man", location: "Southern Season", searcherinterested: true, posterinterested: true )
...
e5 = Event.create!(title: "No Surprises", user_id: q.id, searcher_id: a.id, interests: "beer", description: "Who just crumbles and burns He used to do surgery", location: "Tyler's Taproom", searcherinterested: true, posterinterested: true )
...
e6 = Event.create!(title: "High and Dry", user_id: q.id, searcher_id: b.id, interests: "long walk", description: "My fake plastic love But I can't help the feeling", location: "beach", searcherinterested: true, posterinterested: true)
