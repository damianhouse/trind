...
Message.create!(event_id: e.id, message: "I would love to chat over a latte!", viewed: true)
...
Message.create!(event_id: e2.id, message: "I would love to chat over a latte!", viewed: true)
...
Message.create!(event_id: e3.id, message: "I would love to chat and skate!", viewed: true)
...
Message.create!(event_id: e4.id, message: "I would love to chat and try cheese!", viewed: true)
...
Message.create!(event_id: e5.id, message: "I would love to chat over a beer!", viewed: true)
...
Message.create!(event_id: e6.id, message: "I would love to chat and walk!", viewed: true)
